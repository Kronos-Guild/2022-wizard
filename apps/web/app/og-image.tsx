...
export const ogAlt = "2022 Wizard - Token-2022 Anchor Program Generator";
export const ogSize = {
  width: 1200,
  height: 630,
};
...
const codeLines = [
  { content: "use anchor_lang::prelude::*;", color: "#f5f5f5" },
  { content: "use anchor_spl::token_2022::Token2022;", color: "#f5f5f5" },
  { content: "", color: "" },
  { content: 'declare_id!("Wizard22...");', color: "#c084fc" },
  { content: "", color: "" },
  { content: "#[program]", color: "#fbbf24" },
  { content: "pub mod token_wizard {", color: "#f472b6" },
  { content: "    use super::*;", color: "#f5f5f5" },
  { content: "", color: "" },
  { content: "    pub fn initialize_mint(", color: "#f472b6" },
  { content: "        ctx: Context<InitializeMint>,", color: "#38bdf8" },
  { content: "        name: String,", color: "#38bdf8" },
  { content: "        symbol: String,", color: "#38bdf8" },
  { content: "        uri: String,", color: "#4ade80" },
  { content: "    ) -> Result<()> {", color: "#f472b6" },
  { content: "        // Initialize metadata", color: "#6b7280" },
  { content: "        init_metadata(&ctx, name)?;", color: "#a78bfa" },
  { content: "        Ok(())", color: "#f472b6" },
    ...
    (
      ...
      >
        ...
        >
          ...
          {/* Large grid - vertical lines */}
          {largeVerticalLines.map((x) => (
            <div
              key={`lv-${x}`}
              style={{
                position: "absolute",
          ...
          {/* Large grid - horizontal lines */}
          {largeHorizontalLines.map((y) => (
            <div
              key={`lh-${y}`}
              style={{
                position: "absolute",
